...
<?php
 ...
 ?>
    ...
    <table  border="1px"  >
        <tr>
            <th style="padding: 20px; font-size:20px; width:200px ;text-align:center; ">Sno</th>
       ...
       while($info=$result->fetch_assoc()){
        ...
        <tr>
            ...
            <td style="padding:20px 35px;"><?php echo"<a class = 'deleteButton' onClick=\" javascript:return confirm('Are you sure you want to delete this'); \" href='delete_teacher.php?teacher_id={$info['sno']}'> Delete </a>" ?></td>
        </tr>
        <?php
       }
       ?>
